...
const Shuffle = ({
    ...
    useEffect(() => {
        console.log("Shuffle: Component mounted");
        // Force fonts loaded immediately for debugging
        setFontsLoaded(true);
    ...
    useGSAP(
        () => {
            console.log("Shuffle: useGSAP running", { ref: ref.current, text, fontsLoaded });
            ...
            const build = () => {
                ...
                // Simple manual split that respects spaces
